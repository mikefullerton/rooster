...
public struct RCDemoReminder: Identifiable, Hashable, EventKitCalendarItem {
    ...
    public var description: String {
        "\(type(of: self)): \(self.title), Calendar: \(self.calendar)"
    }
...
extension RCDemoReminder {
    ...
    public var timeLabelDisplayString: String {
        "EventKitReminder Due at: \(self.alarm.startDate))"
    }
}
