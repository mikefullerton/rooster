...
public struct CalendarScheduleBehavior: Equatable, CustomStringConvertible {
    ...
    public var workDays: CalendarScheduleItem.WorkDays
    ...
    public init(workdayStart: TimeDescriptor,
                ...
                visibleDayCount: Int,
                workDays: CalendarScheduleItem.WorkDays) {
...
extension CalendarScheduleBehavior: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.workDays = try values.decodeIfPresent(CalendarScheduleItem.WorkDays.self, forKey: .workDays) ?? defaults.workDays
    }
