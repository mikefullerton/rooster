...
public struct EventKitParticipant: CustomStringConvertible, Equatable, Identifiable, Participant {
    ...
    public init(ekParticipant: EKParticipant) {
        ...
        self.id = ekParticipant.url.absoluteString
    ...
    public func isEqual(to other: AbstractEquatable) -> Bool {
        guard let participant = other as? EventKitParticipant else { return false }
