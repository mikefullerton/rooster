...
//            print("tracking: highlight state: \(state.rawValue), \(Date().shortDateAndLongTimeString), \(self.highlightBackgroundView)")
    ...
    public private(set) var highlightBackgroundView: NSVisualEffectView? = nil
    ...
    open override func preferredLayoutAttributesFitting(_ layoutAttributes: NSCollectionViewLayoutAttributes) -> NSCollectionViewLayoutAttributes {
