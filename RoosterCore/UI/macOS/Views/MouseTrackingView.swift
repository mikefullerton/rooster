...
public protocol MouseTrackingViewDelegate: AnyObject {
...
open class MouseTrackingView : AnimateableView, MouseTrackingViewDelegate {
    
    public weak var mouseTrackingDelegate: MouseTrackingViewDelegate?
...
//        print("tracking: mouse moved")
    ...
    open func mouseStateDidChange() {
        
    }

    open func mouseTrackingView(_ view: MouseTrackingView,
                           mouseMovedAtLocation: CGPoint,
                           withEvent event: NSEvent) {
