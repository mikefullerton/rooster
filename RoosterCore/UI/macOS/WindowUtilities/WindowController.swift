...
open class WindowController: NSWindowController, Loggable {
    ...
    open func setContentViewController(_ viewController: NSViewController) {
...
//            NotificationCenter.default.addObserver(self, selector: #selector(windowWillClose(_:)), name: NSWindow.willCloseNotification, object: window)
    ...
    @objc open func updateWindowFrame(_ notification: Notification) {
    ...
    @objc open func windowWillClose(_ notification: Notification) {
...
//        }
    ...
    @objc open func appWillTerminate(_ notification: Notification) {
