...
open class SDKCustomButtonOld: ContentAwareView, TrackingButtonDelegate, CALayerDelegate {
    ...
    open func setContraints(forView view: NSView, forAlignment alignment: NSTextAlignment) {
...
//        view.setContentCompressionResistancePriority(.defaultHigh, for: .vertical)
    ...
    open func setSizeContraints(forImageView view: NSImageView) {
    ...
    open func setSizeConstraints(forTextField view: NSTextField) {
        NSLayoutConstraint.activate([
            view.heightAnchor.constraint(equalToConstant: view.intrinsicContentSize.height),
            view.widthAnchor.constraint(equalToConstant: view.intrinsicContentSize.width)
        ])
    ...
    open func trackingButton(_ buttton: TrackingButton, didHighlight isHighlighted: Bool) {
