...
//                                         updateAlarmBlock:(_ item: Item, _ newAlarm: RCAlarm) -> Item ) -> [Item] where Item: RCCalendarItem {
//
//        var outItems: [Item] = []
//
...
//    private static func mergeEvents(_ newEvents:[RCEvent],
//                                    withOldEvents oldEvents: [RCEvent]) -> [RCEvent] {
//
//        return self.mergeItems(newEvents, withOldItems: oldEvents) { newEvent, newAlarm in
//            return RCEvent(withIdentifier: newEvent.id,
...
//    }
//
//    private static func mergeReminders(_ newReminders:[RCReminder],
//                                       withOldReminders oldReminders: [RCReminder]) -> [RCReminder] {
//
//        return self.mergeItems(newReminders, withOldItems: oldReminders) { newReminder, newAlarm in
//            return RCReminder(withIdentifier: newReminder.id,
