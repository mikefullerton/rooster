...
public class MenuBarButtonView: MouseTrackingView, Loggable {
    ...
    private lazy var imageView: HighlightableImageView = {
        let view = HighlightableImageView()
        return view
    }()
    ...
    override public init(frame: CGRect) {
        ...
        self.setPositionalContraints(forSubview: self.imageView, alignment: .left)
        self.setPositionalContraints(forSubview: self.textField, alignment: .right)
