...
class MenuBarChoicesView : SimpleStackView, PreferencesContentView {
...
class MenuBarPreferenceView: SinglePreferenceChoiceView {
    ...
    @objc override func checkboxChanged(_ sender: NSButton) {
        ...
        var prefs = AppDelegate.instance.preferencesController.menuBarPreferences
        ...
        AppDelegate.instance.preferencesController.menuBarPreferences = prefs
    }

    override var value: Bool {
        return AppDelegate.instance.preferencesController.menuBarPreferences.options.contains(self.option)
    }
    ...
    override func refresh() {
        ...
        if self.option == .shortCountdownFormat {
            self.checkbox.isEnabled = AppDelegate.instance.preferencesController.menuBarPreferences.options.contains([.countDown, .showIcon])
        }
        
        self.checkbox.isEnabled =   self.option == .showIcon ||
                                    AppDelegate.instance.preferencesController.menuBarPreferences.options.contains(.showIcon)
    }
}
