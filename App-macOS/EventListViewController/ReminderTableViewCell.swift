...
//            self.alarmIcon.tintColor = reminder.calendar.color!
        ...
        self.timeLabel.stringValue = "Reminder Due at: \(reminder.alarm.startDate))"
        self.eventTitleLabel.stringValue = reminder.title
    ...
    @objc override func handleLocationButtonClick(_ sender: NSButton) {
        if let reminder = self.reminder {
            reminder.openLocationURL()
        }
    }
    
    @objc override func handleMuteButtonClick(_ sender: NSButton) {
