...
class SliderView : NSView {
    ...
    private(set) var insets = NSEdgeInsets.zero
    ...
    private(set) var minValueView: NSView?
    private(set) var maxValueView: NSView?
    ...
    @objc private func setMinValue(_ sender: NSButton) {
        self.value = self.minimumValue
        self.slider.sendAction(self.slider.action, to: self.slider.target)
    }

    @objc private func setMaxValue(_ sender: NSButton) {
        self.value = self.maximumValue
        self.slider.sendAction(self.slider.action, to: self.slider.target)
    }
    
    func setViews(minValueView: NSView?,
                  maxValueView: NSView?,
                  insets: NSEdgeInsets = NSEdgeInsets.zero,
