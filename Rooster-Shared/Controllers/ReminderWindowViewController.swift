...
public class ReminderListViewController: EventListViewController {
}

public class ReminderWindowViewController: SDKViewController {
    static let DidChangeEvent = Notification.Name("ReminderWindowViewControllerDidChange")
