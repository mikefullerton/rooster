...
class NotificationChoicesView : SimpleStackView {
    ...
    public var pref: SingleNotificationPreference {
        get {
            return Controllers.preferences.notifications.preference(forKey: self.notificationPreferencesKey)
        }
        set(pref) {
            Controllers.preferences.notifications.setPreference(pref, forKey: self.notificationPreferencesKey)
        }
    }
