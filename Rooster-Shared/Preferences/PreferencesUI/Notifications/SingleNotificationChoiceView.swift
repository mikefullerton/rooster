...
class AutomaticallyOpenLocationURLsChoiceView : SinglePreferenceChoiceView {
    ...
    @objc override func checkboxChanged(_ sender: SDKButton) {
        ...
        var prefs = Controllers.preferencesController.notificationPreferences
        ...
        Controllers.preferencesController.notificationPreferences = prefs
    }
    
    override var value: Bool {
        return Controllers.preferencesController.notificationPreferences.options.contains(.autoOpenLocations)
    }
...
class BounceInDockChoiceView : SinglePreferenceChoiceView {
    ...
    override var value: Bool {
        return Controllers.preferencesController.notificationPreferences.options.contains(.bounceAppIcon)
    }
}
...
class UseSystemNotificationsChoiceView : SinglePreferenceChoiceView {
    ...
    override var value: Bool {
        return Controllers.preferencesController.notificationPreferences.options.contains(.useSystemNotifications)
    }
