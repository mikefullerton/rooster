...
public class PreferencesController: ObservableObject, Loggable {
    ...
    public var todayWindowPreferences: TodayWindowPreferences {
        get { self.preferences.todayWindowPreferences }
        set {
            if self.preferences.todayWindowPreferences != newValue {
                self.logger.debug("\(#function) will update: \(self.preferences.todayWindowPreferences.description), newValue: \(newValue)")
                self.preferences.todayWindowPreferences = newValue
            }
        }
    }

    public var scheduleBehavior: ScheduleBehavior {
        get { self.preferences.scheduleBehavior }
        set {
            if self.preferences.scheduleBehavior != newValue {
                self.logger.debug("\(#function) will update: \(self.preferences.scheduleBehavior.description), newValue: \(newValue)")
                self.preferences.scheduleBehavior = newValue
            }
        }
    }

    public var keyboardShortcut: KeyboardShortcutPreferences {
        get { self.preferences.keyboardShortcutPreferences }
        set {
            if self.preferences.keyboardShortcutPreferences != newValue {
                self.logger.debug("\(#function) will update: \(self.preferences.keyboardShortcutPreferences.description), newValue: \(newValue)")
                self.preferences.keyboardShortcutPreferences = newValue
            }
        }
    }
