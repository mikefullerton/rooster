...
public protocol QuickSearchViewDelegate: AnyObject {
...
open class QuickSearchView: TopBar, NSSearchFieldDelegate, NSTextFieldDelegate {
...
//        self.delegate?.quickSearchViewDidBeginSearching(self, content: self.searchField.stringValue)
    ...
    func addPlaySoundButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            button.leadingAnchor.constraint(equalTo: self.shuffleButton.trailingAnchor, constant: 10)
        ])
    }

    lazy var shuffleButton: SDKButton = {
        guard let button = SDKButton(systemSymbolName: "shuffle",
                                     accessibilityDescription: "Play Random Sound",
        ...
        button.toolTip = "Play Random Sound"
        return button
    }()
