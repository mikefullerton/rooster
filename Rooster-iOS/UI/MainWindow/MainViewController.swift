...
class MainViewController: UIViewController, UIPopoverPresentationControllerDelegate, MainViewControllerMacProtocols, FirstRunViewControllerDelegate, UIActivityItemsConfigurationReading {
    ...
    private func adjustedSize(_ size: CGSize) -> CGSize {
        CGSize(width: max(self.minimumContentSize.width, size.width),
