...
Also, on iOS, you're not able to get delegate calendars from EventKit, so that reduces the usefulness of Rooster on iOS by alot.

-->> So the iOS code isn't building right now <---
